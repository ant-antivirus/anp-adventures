...
function Phase3BSmokeTest.Run(services)
	...
	assertCondition(quest001State.RewardPending == false, "Quest 001 reward should not remain pending after successful completion.")
	...
	assertCondition(finalSnapshot.Data.Quests.QuestStates.quest_ep01_main_008.RewardPending ~= true, "Quest 008 reward should not be pending when completion preflight fails.")
