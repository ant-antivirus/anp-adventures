...
function DeveloperWorldUXSmokeTest.Run(services)
	...
	assertDeveloperLabel(questStart.Data, "Q1 เริ่ม", "interaction_start_ep01_main_001")
	...
	assertDeveloperLabel(questComplete.Data, "Q1 ส่ง", "interaction_complete_ep01_main_001")
	...
	assertDeveloperLabel(questObjective.Data, "Q1 เป้าหมาย 1", "interaction_ep01_main_001_001")
	...
	assertDeveloperLabel(discovery.Data, "จอแสดงผลสตาร์คอร์", "disc_ep01_command_star_core_display")
	...
	assertDeveloperLabel(spawn.Data, "Spawn ศูนย์บัญชาการ", "spawn_ep01_command_default")
