...
function Phase4CQuestTrackerSmokeTest.Run(services)
	...
	assertCondition(string.find(noQuestTracker.HintText or "", "สีเขียว", 1, true) ~= nil, "NoQuest tracker should suggest a green Quest Start marker.")
	...
	assertCondition(string.find(completeReadyTracker.HintText or "", "สีฟ้า", 1, true) ~= nil, "Quest complete-ready tracker should point to cyan marker.")
	...
	assertCondition(string.find(afterQuest001Tracker.HintText or "", "สีเขียว", 1, true) ~= nil, "Completed tracker should guide to next green marker.")
	...
	assertCondition(string.find(episodeCompleteTracker.HintText or "", "สตาร์คอร์ส่วนที่ 1", 1, true) ~= nil, "Episode complete tracker should mention Star Core Segment 01.")
