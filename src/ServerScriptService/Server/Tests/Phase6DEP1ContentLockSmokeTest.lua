...
local function assertTrackerAndOnboardingCompatibility(services)
	...
	assertCondition(OnboardingService.ShouldShowFirstTimeOnboarding(completedPlayer) == false, "Completed Episode 1 player should not receive first-time onboarding.")
